...
//        }
    ...
    private void initComponents() {
        ...
        jLabel_restxname.setFont(new java.awt.Font("FreeMono", 3, 48)); // NOI18N
        jLabel_restxname.setForeground(new java.awt.Color(255, 255, 255));
        jLabel_restxname.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel_restxname.setText("Grills");
        jLabel_restxname.setName(""); // NOI18N
        getContentPane().add(jLabel_restxname);
        jLabel_restxname.setBounds(20, -20, 390, 90);
        ...
        jLabel_Splash.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/a (1).jpg"))); // NOI18N
        getContentPane().add(jLabel_Splash);
        jLabel_Splash.setBounds(-40, -70, 510, 370);
