...
//        String temp = "";
        ...
        public int print(Graphics graphics, PageFormat pageFormat, int pageIndex)
            ...
            if (pageIndex == 0) {
                ...
                try {
                    ...
                    p_st = DBConnect.DBConnect.getConnection().prepareStatement("SELECT `id` FROM `billing_details`", ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                    rs = p_st.executeQuery();
                    rs.last();
                    int id = Integer.parseInt(rs.getString("id")) + 1;

                    g2d.setFont(new Font("Monospaced", Font.PLAIN, 9));
                    g2d.drawString("            Customer Copy                       ", 12, y);
                    y += yShift;
                    g2d.drawString("-------------------------------------", 12, y);
                    y += yShift;
                    g2d.drawString("               Grills                 ", 12, y);
                    y += yShift;
                    g2d.drawString("       Chandni Chowk, New Delhi          ", 12, y);
                    y += yShift;
                    g2d.drawString("       123456789, xyz@ex.com          ", 12, y);
                    y += yShift;
                    g2d.drawString("-------------------------------------", 12, y);
                    y += headerRectHeight;

                    g2d.drawString("Bill No: " + id, 10, y);
                    y += yShift;
                    ...
                    for (int s = 0; s < r; s++) {
                        g2d.drawString(" " + item_selected.get(s) + "                            ", 10, y);
                        y += yShift;
                        g2d.drawString("   QTY. " + qty_selected.get(s), 10, y);
                        g2d.drawString(net_amt.get(s), 160, y);
                        y += yShift;
                    }

                    g2d.drawString("-------------------------------------", 10, y);
                    y += yShift;
                    g2d.drawString(" Total amount:             " + jTextField_total.getText() + "   ", 10, y);
                    y += yShift;
                    y += yShift;
                    g2d.drawString(" Date:  " + dateTime(), 10, y);
                    y += yShift;
                    g2d.drawString("-------------------------------------", 10, y);
                    y += yShift;
                    ...
                    g2d.drawString("*************************************", 10, y);
                    y += yShift;
                    g2d.drawString("      THANK YOU, VISIT AGAIN         ", 10, y);
                    y += yShift;
                    g2d.drawString("*************************************", 10, y);
                    y += yShift;
                    y += yShift;
                    ...
                    y += yShift;
                    y += yShift;
                    g2d.drawString("            Kitchen Copy                       ", 12, y);
                    y += yShift;
                    g2d.drawString("-------------------------------------", 12, y);
                    y += yShift;
                    g2d.drawString("               Grills                 ", 12, y);
                    ...
                    g2d.drawString(" Item Name                    QTY.   ", 10, y);
                    y += yShift;
                    g2d.drawString("-------------------------------------", 10, y);
                    y += headerRectHeight;
                    for (int s = 0; s < r; s++) {
                        g2d.drawString(" " + item_selected.get(s), 10, y);
                        g2d.drawString(qty_selected.get(s), 175, y);
                        y += yShift;
                    }
                    g2d.drawString("-------------------------------------", 10, y);
                    y += yShift;
    ...
    private void initComponents() {
        ...
        jLabel_restxname.setFont(new java.awt.Font("Lato Black", 3, 40)); // NOI18N
        jLabel_restxname.setForeground(new java.awt.Color(105, 105, 0));
        jLabel_restxname.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel_restxname.setText("Welcome to Grills");
        ...
        jLabel_add.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jLabel_remove.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jLabel2.setBounds(830, 410, 50, 20);
        ...
        jLabel_go_back_to_main.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jLabel_update.setBackground(new java.awt.Color(0, 204, 204));
        ...
        jLabel_bg.setBounds(-10, 0, 1030, 520);
...
//              Deleting the item from billing item arraylist
    ...
    private void jLabel_go_back_to_mainMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_go_back_to_mainMouseClicked
        new GrillsInterface.FirstWelcomeScrn().setVisible(true);
        this.dispose();
...
//                    p_st.close();
                            ...
                            String query_bill = "INSERT INTO `billing_details` (`item`, `quantity`,"
                                    + "`price`, `data_time`, `total_price`) VALUES ('"
                                    + all_item + "', '"
                                    + all_qty + "', '"
                                    + all_price + "', '"
                                    + "2008-11-11 13:23:44" + "', '"
