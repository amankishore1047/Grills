...
public class AdminLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_restxname.setBackground(new java.awt.Color(0, 0, 0));
        jLabel_restxname.setFont(new java.awt.Font("Lato Black", 3, 32)); // NOI18N
        ...
        jCheckBox_show_pass.setBounds(130, 320, 140, 28);
        ...
        jLabel_bg.setBounds(-770, -760, 1430, 1970);
            ...
            if (!rs.next()) {
                JOptionPane.showMessageDialog(null, "Invalid Username or Password!", "Login Error", 2);
                    ...
                    if (rs.getString("password").equals(password) && rs.getString("username").equals(username)) {
                            new GrillsInterface.AdminPanel().setVisible(true);
                            this.dispose();
