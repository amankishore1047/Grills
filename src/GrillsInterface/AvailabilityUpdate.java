...
public class AvailabilityUpdate extends javax.swing.JFrame {
    ...
    public AvailabilityUpdate() {
        ...
        itemComboBox();
        jTable_menu.setAutoCreateRowSorter(true);
        jTable_menu.setDefaultEditor(Object.class, null);
        
        //jTable_updated modification
        jTable_updated.setAutoCreateRowSorter(true);
        jTable_updated.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
...
//                System.out.println(cnt_query);
    ...
    private void initComponents() {
        ...
        jLabel_qty.setBounds(60, 380, 90, 28);
        ...
        jLabel_update.setBackground(new java.awt.Color(153, 153, 255));
        ...
        jLabel_remove.setBackground(new java.awt.Color(153, 153, 255));
        ...
        jLabel_add_item.setBackground(new java.awt.Color(153, 153, 255));
        ...
        jLabel_add_item.setBounds(170, 430, 130, 40);

        jLabel_go_to_main_menu.setBackground(new java.awt.Color(153, 153, 255));
...
//            Checking the validity of the quantity
...
//                    success = p_st_temp.executeUpdate();
                    ...
                    JOptionPane.showMessageDialog(null, "Please press Update button to update quantity.","Item already exists!",2);
                    return;
                }
            ...
            Logger.getLogger(AvailabilityUpdate.class.getName()).log(Level.SEVERE, null, e);
            JOptionPane.showMessageDialog(null, "Please select an item from main menu.", "Selection error!", 0);
            jTextField_qty.setText("");
        } 
